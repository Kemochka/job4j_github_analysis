...
class RepositoryServiceTest {
    ...
    void whenFindCommitsByRepositoryName() {
        ...
        var commits = repositoryService.findCommitsByRepository("test");
        assertThat(commits).hasSize(1);
        assertThat(commits.get(0).getMessage()).isEqualTo("First commit");
    ...
    void whenFindLatestCommit() {
        ...
        assertThat(latestCommit.getMessage()).isEqualTo("First commit");
